...
namespace WebApplication1.Models
{
	...
	public partial class DONDATHANG : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.Nullable<bool> _Trinhtranggiaohang;
    ...
    partial void OnTrinhtranggiaohangChanging(System.Nullable<bool> value);
    partial void OnTrinhtranggiaohangChanged();
    #endregion
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Trinhtranggiaohang", DbType="Bit")]
		public System.Nullable<bool> Trinhtranggiaohang
		{
			get
			{
				return this._Trinhtranggiaohang;
			}
			set
			{
				if ((this._Trinhtranggiaohang != value))
				{
					this.OnTrinhtranggiaohangChanging(value);
					this.SendPropertyChanging();
					this._Trinhtranggiaohang = value;
					this.SendPropertyChanged("Trinhtranggiaohang");
					this.OnTrinhtranggiaohangChanged();
				}
			}
		}
    ...
    partial void OnDienthoaKHChanging(string value);
    partial void OnDienthoaKHChanged();
    ...
    partial void OnNgaysinhChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_DienthoaKH", DbType="VarChar(50)")]
		public string DienthoaKH
		{
			get
			{
				return this._DienthoaKH;
			}
			set
			{
				if ((this._DienthoaKH != value))
				{
					this.OnDienthoaKHChanging(value);
					this.SendPropertyChanging();
					this._DienthoaKH = value;
					this.SendPropertyChanged("DienthoaKH");
					this.OnDienthoaKHChanged();
				}
			}
		}
